(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      ".statusfy-item{border-radius:1rem;border:1px solid #e4c6c4;background:#fff;padding:0.85rem 0.95rem;margin-top:0.65rem;}",
      ".statusfy-item.is-ours{box-shadow:0 0 0 2px rgba(114,31,44,.22);}",
      ".statusfy-item-top{display:flex;align-items:flex-start;justify-content:space-between;gap:0.6rem;}",
      ".statusfy-name{font-weight:700;color:#721f2c;font-size:0.95rem;}",
      ".statusfy-ours{display:inline-block;margin-top:0.2rem;font-size:0.7rem;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:#721f2c;}",
      ...
      ".statusfy-full{display:inline-block;margin-top:0.75rem;font-size:0.8rem;font-weight:700;color:#721f2c;text-decoration:none;}",
